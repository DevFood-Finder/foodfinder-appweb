...
@Component({
  selector: 'app-crate-account-client',
  templateUrl: './create-account-client.component.html',
  standalone: true,
  imports: [
    ReactiveFormsModule
  ],
  styleUrl: './create-account-client.component.css'
})

export class CreateAccountClientComponent extends BaseFormComponent implements OnInit{
  form!: FormGroup;
  submitted = false;
